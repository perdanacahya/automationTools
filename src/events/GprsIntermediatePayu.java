...
public class GprsIntermediatePayu
        extends Event2 {
    ...
    protected void noResponseHandle() {
        ...
        HashMap<String, String> result = ssh.getLastTransactionPayu(this.session, "52u", this.a_number);
        ...
        if (result.containsKey("xml") && !result.containsKey("grepError")) {
            ...
            setResponseData("### " + this.session + " ### " + xml + " ### GPRS Intermediate " + this.total_octets + " B OK");
            System.out.println("### " + this.session + " ### " + xml + " ### GPRS Intermediate " + this.total_octets + " B OK");
        } else {
    ...
    public GprsIntermediatePayu(SimpleSyncClient test, String a_number, String session, int ccnumber, String station_id, String sgsn, int rating_group, long total_octets, String id) {
        super(test);
    ...
    public GprsIntermediatePayu(SimpleSyncClient test, String a_number, String session, int ccnumber, String station_id, String sgsn, int rating_group, long total_octets, String cgi, String id) {
    ...
    protected void prepareRequest() {
        ...
        this.avps.add(new AVP_Integer32(416, 2));
        ...
        try {
            ...
            Logger.getLogger(GprsIntermediatePayu.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

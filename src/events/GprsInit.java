...
public class GprsInit
    ...
    public GprsInit(SimpleSyncClient test, String a_number, String apn, String sgsn, int rating_group, String id) {
        super(test);
    ...
    public GprsInit(SimpleSyncClient test, String a_number, String apn, String sgsn, int rating_group, String cgi, String id) {
        this(test, a_number, apn, sgsn, rating_group, id);
        this.cgi = cgi;
    }
    ...
    protected void successHandle() {
        ...
        HashMap<String, String> result = ssh.getLastTransaction(getSession(), "51u", this.a_number);
        ...
        if (result.containsKey("grepErrorSession")) {
            ...
            start();
        } else if (result.containsKey("xml") && result.containsKey("errorcode")) {
            setResponseData("### " + getSession() + " ### GPRS Init OK");
            System.out.println("### " + getSession() + " ### GPRS Init OK");
    ...
    protected void noResponseHandle() {
        ...
        if (result.containsKey("grepErrorSession")) {
            ...
            setResponseData("### " + getSession() + " ### " + xml + " ### GPRS Init OK");
            System.out.println("### " + getSession() + " ### GPRS Init OK");

...
public class ContentRefund
    ...
    public ContentRefund(SimpleSyncClient test, String a_number, String cost_code, String code, String id) {
        super(test);
    ...
    protected void successHandle() {
        ...
        if (result.containsKey("xml") && !result.containsKey("grepError")) {
            ...
            setResponseData("### " + getSession() + " ### " + xml + " ### ContentRefund (" + this.a_number + ") " + this.cost_code + " OK" + ", pemakaian:  Charge Amount " + basicValue + ", After monetary allowance " + afterAllowance);
        } else {

...
public abstract class Event2 {
    ...
    private static final Logger log = Logger.getLogger(Event2.class.getName());
    private int loop = 0;
    private int CloseParameter = 0;

    public Event2(SimpleSyncClient client) {
    ...
    private void processAnswer() {
        if (this.avps == null) {
            ...
            try {
                ...
                Logger.getLogger(Event2.class.getName()).log(Level.SEVERE, null, ex);
            }
            noResponseHandle();
            return;
        }
    ...
    protected abstract void failHandle(int rc);
